...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO users2 (first_name, last_name, email, username, password, role, card_number, card_name, expiration_date, billing_address, phone_number) 
            VALUES ('$first_name', '$last_name', '$email', '$username', '$password', '$role', '$card_number', '$card_name', '$expiration_date', '$billing_address', '$phone_number')";
